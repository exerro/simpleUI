...
import com.exerro.simpleui.layout.*

fun main() {
    val window = GLFWWindowCreator.createWindow("Layout")
    ...
    window.draw {
        ...
        layout {
            hdiv(30.percent) {
                        ...
                        withPadding(32.px) {
                            valign(1f) {
                                vflow(spacing = 32.px, reversed = true) {
                                    for ((width, height, colour) in sidebarElements) {
                                        halign(0.5f) {
                ...
                vdiv(48.px) {
                    withPadding(top = 16.px, left = 16.px, right = 16.px) {
                        hdiv(spacing = 16.px) {
                            for (i in 1..8) {
                                drawElement {
                    ...
                    stack {
                        withSize(width = 192.px, height = 128.px, horizontalAlignment = 0f, verticalAlignment = 0f) {
                        ...
                        withSize(width = 128.px, height = 128.px, horizontalAlignment = 0f, verticalAlignment = 0f) {
